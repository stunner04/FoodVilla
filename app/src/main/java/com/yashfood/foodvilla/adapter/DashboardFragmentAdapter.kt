...
import com.yashfood.foodvilla.activity.RestaurantMenuActivity
...
class DashboardFragmentAdapter(val context: Context, var itemList: ArrayList<Restaurant>) :
    ...
    class DBAsyncTask(val context: Context, val restaurantEntity: RestaurantEntity, private val mode: Int) :
