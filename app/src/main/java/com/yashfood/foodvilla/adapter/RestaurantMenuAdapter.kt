...
import com.yashfood.foodvilla.activity.CartActivity
import com.yashfood.foodvilla.model.RestaurantMenu
    ...
    override fun onBindViewHolder(holder: ViewHolderRestaurantMenu, position: Int) {
        ...
        holder.btnAddToCart.setOnClickListener {
            ...
            if (holder.btnAddToCart.text.toString() == "Remove") {
                ...
                holder.btnAddToCart.setBackgroundResource(R.drawable.button_view_2)
                ...
                holder.btnAddToCart.setBackgroundResource(R.drawable.button_view_3)
